<template>
    <div class="supplyAddGoods containerBoxInfo" :style="height" :loading="cascaderLoading">
...
<script>
    ...
    export default {
        ...
        computed: {
            ...
            changeType () {
                return this.$store.state.goods.changeType
            }
        },
        ...
        methods: {
            ...
            next() {
                ...
                this.$router.push({name: 'supplyGoodsInfo', query: {data: qs.stringify(row)}})
            },
            cascaderChange(val) {
