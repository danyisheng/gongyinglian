...
export default {
  ...
  methods: {
    ...
    beforeLogin(params) {
      ...
      params.Pwd = this.loginForm.newPassword;
      this.$store
        .dispatch("user/registLogin", params)
        .then(res => {
          console.log(res,'res')
          if(res){
            this.$message.error(res.data.Msg)
    ...
    handleLogin() {
      ...
      this.$refs.loginForm.validate(valid => {
        if (valid) {
          if (that.loginForm.password.trim() == that.loginForm.newPassword.trim()&&that.loginForm.password.trim()) {
            that.checkCode();
          } else {
