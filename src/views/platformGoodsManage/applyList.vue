        ...
        <div class="toolbar-box">
            <common-row>
                ...
                <common-col :height="50">
                    <div class="btn-box displayflex">
                        <label for="">联系人：</label>
                        <el-input v-model="searchBox.ContPsonMobileOrName" placeholder="请输入联系人姓名/手机号" clearable></el-input>
                    </div>
                </common-col>
            </common-row>
            <common-row>
            ...
            <el-tabs v-model="activeName" @tab-click="handleClick">
                <el-tab-pane label="待审核" name="1000">
                    <el-table
                        ...
                        <el-table-column prop="CreatorName" label="联系信息">
                            <template slot-scope="scope">
                                <div cclass="timer-box">
                                    <p>{{scope.row.ContPsonName}}</p>
                                    <p>{{scope.row.ContPsonMobile}}</p>
                                </div>
                            </template>
                        </el-table-column>
                        ...
                        <el-table-column prop="action" label="操作" align="center">
                            <template slot-scope="scope">
                                <div class="table-btn-box">
                                    <a href="javascript:;" @click="goodsDetail(scope.row)">审核</a>
                                </div>
                            </template>
                        </el-table-column>
                    </el-table>
                ...
                <el-tab-pane label="审核通过" name="2000">
                    <el-table
                        ...
                        <el-table-column prop="ManageUserName" label="审核人"></el-table-column>
                        <el-table-column prop="SinglePrice" label="价格"></el-table-column>
                        <el-table-column prop="InvQuantity" label="库存"></el-table-column>
                        <!--<el-table-column prop="action" label="操作" align="center">-->
                        <!--<template slot-scope="scope">-->
    ...
    export default {
        ...
        methods: {
            handleClick(val) {
                ...
                if(val.name==1000){
                    this.status=4000
                }else if(val.name==2000){
                    this.status=2000
                }else if(val.name==3000){
                    this.status=3000
                }else if(val.name==4000){
                    this.status=0
                }
            ...
            cancelSupplyGoods() {
                this.reviewActionDatas(4000, '撤销申请', '商品', 'ManageReason')
            },
            underSupplyGoods() {
            ...
            getData() {
                let params = {
                    ...
                    ContPsonMobileOrName: this.searchBox.ContPsonMobileOrName,
                    ReviewStatus: Number(this.activeName),
                }
