<template>
  <div class="auditRefuseDetail">
    <common-row>
      <common-col :lot="7" :height="50">
        <div class="btn-box">
          <label for>供应商名称：</label>
          <el-input v-model="searchBox.goodsName" placeholder="请输入供应商名称" disabled></el-input>
        </div>
      </common-col>
    </common-row>
    <common-row>
    ...
    <common-row>
      <common-col :lot="7" :height="50">
        <div class="btn-box">
          <label for>联系人：</label>
          <el-input v-model="searchBox.goodsName" placeholder="请输入供应商账号" disabled></el-input>
        </div>
      </common-col>
      <common-col :lot="7" :height="50">
        <div class="btn-box">
     ...
     <common-row class="shenFenZheng" >
      <common-col :lot="8" :height="230">
        <div class="btn-box">
          ...
          <div class="result">
            <textarea placeholder="请输入拒绝原因 " disabled></textarea>
          </div>
        </div>
      </common-col>
    </common-row>
    <common-row  >
      <common-col :lot="8" :height="50">
        <div class="btn-box">
          <label for></label>
          <el-button size="medium" type="">关闭</el-button>
        </div>
      </common-col>
    </common-row>
  </div>
