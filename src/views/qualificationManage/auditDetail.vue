<template>
  <div class="auditDetail" :style="height">
    <el-form ref="form" :model="formData" label-width="140px">
     ...
     <div class="weituoShouQuan">
      ...
      <common-row>
        ...
        <common-col :lot="7" :height="50">
          <el-form-item label="提交时间：" class="form_box">
            <el-input v-model="formData.SubmitTime" placeholder="请输入提交时间" disabled></el-input>
          </el-form-item>
        </common-col>
      </common-row>
      <common-row>
        <common-col :lot="7" :height="50">
          <el-form-item label="审核结果：" class="form_box">
            <el-input v-model="obj[formData.Status]" placeholder="请输入审核结果" disabled></el-input>
          </el-form-item>
        </common-col>
        <common-col :lot="7" :height="50">
          <el-form-item label="审核人：" class="form_box" >
            <el-input v-model="formData.AuditPson" placeholder="请输入审核人" disabled></el-input>
          </el-form-item>
        </common-col>
      </common-row>
      <common-row>
      ...
      <common-row class="shenFenZheng" v-if="this.formData.Status==3000">
      ...
      <common-row>
        <common-col :lot="8" :height="50">
          <div class="btn-box">
            <label for></label>
            <el-button size="medium" type @click="$router.go(-1)">关闭</el-button>
          </div>
        </common-col>
      </common-row>
    </el-form>
      ...
      this.$https
        ...
        .then(res => {
          if (res.data.ErrorCode === 200) {
            ...
            this.formData.SubmitTime = res.data.Data.SubmitTime;
            ...
            this.formData.AuditPson = res.data.Data.AuditPson;
            //图片
